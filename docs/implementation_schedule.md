...
|--------|-----------|-----------------------------------------------------------------|------------------------|---------------------------------------------------------------|-----------------------|-------------|------------------------------------------|
| Week 1 | DevEx/CI  | Initialize repo structure and configure basic branching model    | Project Lead           | Repo with base folders (src, docs, tests) committed          | [DoD: Setup]          | ☐ Not Started | Align with org/repo standards            |
| Week 1 | Docs      | Create front-door docs (README, [Project Brief](./project_brief.md))             | Docs / PM              | `README.md` + `docs/project_brief.md`                        | [DoD: Docs]           | ☐ Not Started | Link to related projects if relevant     |
| Week 1 | Discovery | Clarify problem statement, scope, and non-goals                 | Project Lead           | Updated project brief incl. {{NONGOALS}}                     | [DoD: Scope]          | ☐ Not Started | Incorporate stakeholder input            |
| Week 1 | DevEx/CI  | Set up dev environment and CI stub (lint/test placeholder)      | DevEx/CI               | CI job that runs basic checks on push                        | [DoD: Testing]        | ☐ Not Started | Ensure team can run locally and in CI    |
| Week 1 | DataOps   | Validate access to core dependencies (APIs, datasets, secrets)   | DataOps                | “Access check” notebook/log with pass/fail status            | [DoD: Dependencies]   | ☐ Not Started | Requires {{DEPENDENCIES}}                |
| Week 1 | Docs      | Close loop with session log (capture key setup decisions)       | Docs / PM              | Week 1 session log entry linked from project brief           | [DoD: Session Log]    | ☐ Not Started | Use standard session-log template        |
